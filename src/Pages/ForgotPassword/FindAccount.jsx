        ...
        <div className=' h-[85vh] flex justify-center items-center px-3'>
            <div className='p-4 w-[570px] shadow-lg rounded-md bg-[#FFFFFF]'>
                  ...
                  <div className='flex justify-center items-center mt-3'>
                        <input type="text" className=' w-[70%] border-2 border-gray-300 rounded-md p-3 mt-2 outline-none  focus:border-blue-500 bg-[#F9FAFB]' placeholder='Your Email or Mobile Number...'/>
                  </div>
                  <hr  className='my-4'/>
